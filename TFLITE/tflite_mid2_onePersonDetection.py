...
# Forzar el uso de WindowsPath
temp = pathlib.PosixPath
pathlib.PosixPath = pathlib.WindowsPath

model = torch.hub.load('ultralytics/yolov5', 'custom', path='C:/Users/edwin/Documents/IoT/EntornosVENV/YOLO/deteccion_personalizada/best.pt', force_reload=True)
